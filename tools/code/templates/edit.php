...
<div class="admin-con-right">
  <form>
    <div class="navi">
      <div class="l"><a href="#" class="h add"><span class="fa fa-edit"></span>&nbsp;修改</a> <a href="?c=__table__" class="fa fa-arrow-left">返回管理页面</a> </div>
      <div class="C"></div>
    </div>
...
$('form').submit(function(){
	ajaxData("?c=__table__&a=update&id=<?=$row['id']?>",$(this).serialize(),function (data){
		 if(data.code>0){
